    ...
    for epoch in range(start_epoch, opt.n_epochs + 1):
        ...
        for data in dataset:
            ...
            if total_iters % opt.print_freq == 0:
                ...
                print_util.print_losses(epoch, epoch_iters, losses, t_comp, t_data, opt)
        ...
        val_loss = losses['recon']  # should change to losses['recon'] + opt.coeff * losses['entropy']
